...
//		gl.glGenTextures(1, tmp);
	...
	public Texture getTexture(String resourceName,  int dstPixelFormat, int minFilter, int magFilter) throws IOException {
		...
		Texture texture = new Texture(textureID, GL.GL_TEXTURE_2D, GL.GL_LINEAR,);
...
//				target,
	 ...
	 */
	private ByteBuffer convertImageData(BufferedImage bufferedImage, KGTexture texture) {
...
//		imageBuffer.rewind();
	...
	private BufferedImage loadImage(String ref) throws IOException
	{
		...
		BufferedImage bufferedImage = ImageIO.read(new BufferedInputStream(getClass().getClassLoader()
